          ...
          builder: (
            ...
            return AppBar(
              ...
              title: Text(
                ...
                style: TextStyle(fontSize: 70.px, fontWeight: FontWeight.bold),
              ),
              actions: <Widget>[
                IconButton(
                    ...
                    children: <Widget>[
                      if (favouriteViewModel.isDownloading)
                        Padding(
                          ...
                          child: Text(
                            'Downloading ${favouriteViewModel.downloadCompleted}'
                      ...
                      Wrap(
                        ...
                        children: <Widget>[
                          TextButton.icon(
                            onPressed: favouriteViewModel.selectedCount == 0 ||
                                    favouriteViewModel.isDownloading
                                ? null
                                : favouriteViewModel.removeSelectedFavourites,
                            icon: const Icon(Icons.delete),
                            label: Text('Remove (${favouriteViewModel.selectedCount})'),
                          ),
                          TextButton.icon(
                            onPressed: favouriteViewModel.selectedCount == 0 ||
                                    favouriteViewModel.isDownloading
                            ...
                            label: Text(
                              favouriteViewModel.isDownloading
                                  ? 'Downloading...'
                                  : 'Download (${favouriteViewModel.selectedCount})',
                            ),
                          ),
                          TextButton(
                            onPressed: favouriteViewModel.toggleManageMode,
